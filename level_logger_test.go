...
func TestLevelLogger(t *testing.T) {
	...
	t.Run("logs at levels", func(t *testing.T) {
		...
		l.DebugF(context.Background(), func() (string, Fields) { return "another msg for debug", nil })
		l.Info(context.Background(), "an info msg", nil)
		l.InfoF(context.Background(), func() (string, Fields) { return "some info msg", nil })
		l.Warn(context.Background(), "a warning", nil)
		l.WarnF(context.Background(), func() (string, Fields) { return "warn msg", nil })
